- view: accounts_history
  sql_table_name: salesforce_b2b.accounts_history
  fields:
  ...
  - measure: count
    type: count
    drill_fields: [dpm_name, account_name, accounts.dpm_name, accounts.account_name, accounts.account_id]
